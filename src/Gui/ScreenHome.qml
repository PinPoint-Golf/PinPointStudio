                ...
                Row {
                    ...
                    Repeater {
                        model: [
                            ...
                            { icon: "⌖", name: qsTr("Wrist motion"),   desc: qsTr("Hit shots with IMUs on your lead wrist and hand to assess how your wrist angles impact club delivery"),              img: "qrc:/assets/tiles/grip.png",      reqCameras: 0, optCameras: true, reqImus: 2, idx: 1 },
