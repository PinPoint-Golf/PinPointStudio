...
def generate(out_dir, seed=7, waggle=True, clutter=False,
    ...
    doc = {
        ...
        # Capture provenance (mirrors the app's "capture" block) so synthetic
        # swings exercise every metadata reader: sessionType from JSON, fps
        # from the stream (60 here, NOT the legacy 150 default), device rates,
        # perspective-driven face-on, and calibration filtering.
        "capture": {
            "sessionType": 1, "shotSource": 0,
